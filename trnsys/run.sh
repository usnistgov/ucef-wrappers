...
cd $root_directory/example/PVT_deployment/
...
cd $root_directory/example/PVT_deployment
xterm -fg yellow -bg black -l -lf $logs_directory/external-java-${timestamp}.log -T "External Java" -geometry 140x40+180+60 -e "mvn exec:java -P ExecJava,ExternalJava" &
waitUntilJoined ExternalJava 1

cd $root_directory/example/PVT_generated/TRNSYS
xterm -fg green -bg black -l -lf $logs_directory/trnsys-${timestamp}.log -T "TRNSYS Federate" -geometry 140x40+360+120 -e "sh run.sh" &
